<template>
  <main class="DemoView">
    <div class="titleStyle">Floor Test</div>
...
import { PhysicRectangle } from '@/Game/Objects/PhysicRectangle'
...
// game.addObject(new PhysicBall(new Vector2(300, 200), 50, "green"))
// game.addObject(new PhysicBall(new Vector2(300, 100), 10, "green"))

const actvieRec: PhysicRectangle = new PhysicRectangle(70, 70, new Vector2(), 'red')

game.addObject(actvieRec)

actvieRec.move(new Vector2(280, 200))

const collider: CollidableRectangle = new CollidableRectangle(5000, 200)
game.addObject(collider)
// collider.rotate(0.55)
...
const ball: PhysicBall = new PhysicBall(new Vector2(200, 30), 200, 'red')
game.addObject(ball)
</script>
